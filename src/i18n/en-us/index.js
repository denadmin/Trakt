export default {
  ...
  analysis: {
    ...
    playingVsBot: "Playing vs Bot — click to change, right-click to stop",
    knodes: "{count} knodes",
    knps: "kN/s",
    limit: "Search Limit",
  ...
  botGame: {
    ...
    botPlays: "Bot plays",
    unsupportedSize: "{engine} does not support a {size} × {size} board",
    movesNow: "{bot} moves now in this position",
    waitsForYou: "{bot} waits for your move",
